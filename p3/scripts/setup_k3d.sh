...
echo ""
echo "How to access the wil42 application (after deployment):"
echo "- Recommended (port-forward): kubectl -n dev port-forward svc/macauchy-app 8888:8888"
echo "  Then open: http://localhost:8888"
echo "- Direct LoadBalancer access: kubectl -n dev get svc macauchy-app"
echo "  Then curl: http://<EXTERNAL-IP>:8888/"
echo ""
